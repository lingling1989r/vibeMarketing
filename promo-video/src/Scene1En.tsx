  ...
  return (
    <div style={{ width: "100%", height: "100%", position: "relative", overflow: "hidden" }}>
      <div style={{ position: "absolute", inset: 0, transform: `scale(${bgScale})`, transformOrigin: "center" }}>
        <Img src={staticFile("images/scene1-mic.jpg")} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
      </div>
      <div style={{
      ...
      <div style={{
        ...
        <div style={{
          opacity: textOpacity, fontSize: 34, fontWeight: 700,
          color: "#f1f5f9", letterSpacing: 1, textAlign: "center",
        ...
        <div style={{
          transform: `scale(${0.4 + hourSpring * 0.6})`, opacity: hourSpring,
          ...
          <span style={{ fontSize: 44, fontWeight: 700, color: "#7c3aed" }}>hour</span>
        </div>

        <div style={{
          opacity: subtextOpacity, fontSize: 22, color: "#94a3b8",
